...
registers into the shared caller-owned C result contract. Both current MAX31865
conformance-vector families run against Python and C. The SPI/delay-driven
one-shot acquisition sequence and HERO adapter remain under 0.2 development,
so the C MAX31865 driver is not yet complete.
